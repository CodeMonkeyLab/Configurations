...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5 Pro/BigTreeTech SKR Mini E3 2.0"
...
#define STRING_CONFIG_H_AUTHOR "(codemonkeylab, Ender-5 Pro)" // Who made the changes.
